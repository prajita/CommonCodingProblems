...
public class CheckIfATreeIsSubtree {
...
//		root.left.left.right = new Node(9);
		...
		System.out.println(checkSubtree(root1, root));
	}

	private static boolean checkSubtree(Node root1, Node root) {
		...
		if (checkIdentical(root1, root))
			return true;
		return checkSubtree(root1.left, root) || checkSubtree(root1.right, root);
